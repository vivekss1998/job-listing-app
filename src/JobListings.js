...
const JobListings = () => {
  ...
  const [skeletonLoading, setSkeletonLoading] = useState(true); // Skeleton loader state
              ...
              <Card title={job.title} className="p-shadow-3">
                ...
                <div style={{ display: 'flex' }}>
                  <a
                    ...
                    style={{ marginRight: '0.5rem', display: 'flex', alignItems: 'center', textDecoration: 'none' }}
                  >
